...
(function() {
  ...
  /**
   * @ngdoc workflow
   * @name horizon.dashboard.compute.instancess.workflow
   * @description Service for the create/update workflow
   */
  angular
    .module('horizon.dashboard.compute.instancess')
    .factory('horizon.dashboard.compute.instancess.workflow', workflow);

  workflow.$inject = [
    'horizon.dashboard.compute.basePath',
      ...
      form = [
        {
          ...
          "tabs": [
            {
              "title": gettext("Info"),
              "help": basePath + "instancess/workflow/info.help.html",
              "items": [
                {
                  "key": "name",
                  "placeholder": gettext("Name of the instances."),
                  "required": true
                },
                {
                  "key": "description",
            ...
            },
            {
              ...
              "help": basePath + "instancess/workflow/recipe.help.html",
              "items": [
                {
                  "key": "size",
                  "type": "radiobuttons",
