...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.xneelo.containers.objects-batch-actions.create-folder',
             createFolderService)
    .factory('horizon.dashboard.xneelo.containers.objects-batch-actions.delete', deleteService)
    .factory('horizon.dashboard.xneelo.containers.objects-batch-actions.upload', uploadService)
    .run(registerActions);

  registerActions.$inject = [
    'horizon.framework.conf.resource-type-registry.service',
    'horizon.dashboard.xneelo.containers.object.resourceType',
    'horizon.dashboard.xneelo.containers.objects-batch-actions.create-folder',
    'horizon.dashboard.xneelo.containers.objects-batch-actions.delete',
    'horizon.dashboard.xneelo.containers.objects-batch-actions.upload'
  ];
  ...
  function uploadModal(html, $uibModal) {
    var localSpec = {
      backdrop: 'static',
      controller: 'horizon.dashboard.xneelo.containers.UploadObjectModalController as ctrl',
      templateUrl: html
    };
