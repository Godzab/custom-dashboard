...
(function() {
  ...
  describe('horizon.dashboard.xneelo.containers edit-object controller', function() {
    var controller, ctrl;
    ...
    beforeEach(inject(function ($injector) {
      ...
      ctrl = controller('horizon.dashboard.xneelo.containers.EditObjectModalController');
    }));
