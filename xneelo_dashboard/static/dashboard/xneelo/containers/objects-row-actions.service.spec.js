...
(function() {
  ...
  describe('horizon.dashboard.xneelo.containers objects row actions', function test() {
    beforeEach(module('horizon.app.core.openstack-service-api'));
    beforeEach(module('horizon.framework'));
    beforeEach(module('horizon.dashboard.xneelo'));

    var $window = {location: {href: 'ham'}};

    beforeEach(module(function before($provide) {
      $provide.constant('horizon.dashboard.xneelo.containers.basePath', '/base/path/');
    ...
    beforeEach(inject(function inject($injector, _$uibModal_, _$httpBackend_, _$rootScope_) {
      ...
      var objectResCode = $injector.get('horizon.dashboard.xneelo.containers.object.resourceType');
      rowActions = resourceService.getResourceType(objectResCode).itemActions;
      model = $injector.get('horizon.dashboard.xneelo.containers.containers-model');
    ...
    describe('viewService', function test() {
      ...
      beforeEach(inject(function inject($injector, _$q_) {
        ...
        viewService = $injector.get('horizon.dashboard.xneelo.containers.objects-actions.view');
        $q = _$q_;
      }));
    ...
    describe('editService', function test() {
      ...
      beforeEach(inject(function inject($injector, _$q_) {
        swiftAPI = $injector.get('horizon.app.core.openstack-service-api.swift');
        editService = $injector.get('horizon.dashboard.xneelo.containers.objects-actions.edit');
    ...
    describe('copyService', function test() {
      ...
      beforeEach(inject(function inject($injector, _$q_) {
        swiftAPI = $injector.get('horizon.app.core.openstack-service-api.swift');
        copyService = $injector.get('horizon.dashboard.xneelo.containers.objects-actions.copy');
        modalWaitSpinnerService = $injector.get(
          'horizon.framework.widgets.modal-wait-spinner.service'
        );
        toastService = $injector.get('horizon.framework.widgets.toast.service');
      ...
      it('should handle copy success correctly', function() {
        ...
        model.container = {name: 'spam'};
        $rootScope.$apply();
        $httpBackend.expectGET('/static/dashboard/xneelo/containers/objects.html').respond({});
