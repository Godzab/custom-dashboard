...
(function() {
  ...
  angular
    .module('horizon.dashboard.xneelo.containers')
    .factory('horizon.dashboard.xneelo.containers.objects-actions.delete', deleteService)
    .factory('horizon.dashboard.xneelo.containers.objects-actions.download', downloadService)
    .factory('horizon.dashboard.xneelo.containers.objects-actions.edit', editService)
    .factory('horizon.dashboard.xneelo.containers.objects-actions.view', viewService)
    .factory('horizon.dashboard.xneelo.containers.objects-actions.copy', copyService)
    .run(registerActions);

  registerActions.$inject = [
    'horizon.framework.conf.resource-type-registry.service',
    'horizon.dashboard.xneelo.containers.object.resourceType',
    'horizon.dashboard.xneelo.containers.objects-actions.delete',
    'horizon.dashboard.xneelo.containers.objects-actions.download',
    'horizon.dashboard.xneelo.containers.objects-actions.edit',
    'horizon.dashboard.xneelo.containers.objects-actions.view',
    'horizon.dashboard.xneelo.containers.objects-actions.copy',
  ...
  viewService.$inject = [
    ...
    'horizon.dashboard.xneelo.containers.basePath',
    'horizon.dashboard.xneelo.containers.containers-model',
    'horizon.framework.util.q.extensions',
    '$uibModal'
  ];
  ...
  function editService(swiftAPI, basePath, model, $qExtensions, modalWaitSpinnerService,
    ...
    function perform(file) {
      var localSpec = {
        backdrop: 'static',
        controller: 'horizon.dashboard.xneelo.containers.EditObjectModalController as ctrl',
  ...
  copyService.$inject = [
    'horizon.app.core.openstack-service-api.swift',
    'horizon.dashboard.xneelo.containers.basePath',
    'horizon.dashboard.xneelo.containers.containerRoute',
    'horizon.dashboard.xneelo.containers.containers-model',
    'horizon.framework.util.q.extensions',
    'horizon.framework.widgets.modal-wait-spinner.service',
    'horizon.framework.widgets.toast.service',
  ...
  function copyService(swiftAPI,
    ...
    function perform(file) {
      var localSpec = {
        backdrop: 'static',
        keyboard: false,
        controller: 'horizon.dashboard.xneelo.containers.CopyObjectModalController as ctrl',
