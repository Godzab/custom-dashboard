...
(function() {
  ...
  /**
   * @ngdoc overview
   * @ngname horizon.dashboard.xneelo.containers
   *
   * @description
   * Provides the services and widgets required
   * to support and display the xneelo containers panel.
   */
  angular
    ...
    .constant('horizon.dashboard.xneelo.containers.account.resourceType', 'OS::Swift::Account')
    .constant('horizon.dashboard.xneelo.containers.container.resourceType', 'OS::Swift::Container')
    .constant('horizon.dashboard.xneelo.containers.object.resourceType', 'OS::Swift::Object')
    .config(config)
    .run(run);
  ...
  /**
   * @name horizon.dashboard.xneelo.containers.basePath
   * @description Base path for the xneelo dashboard
   */
  function config($provide, $routeProvider, $windowProvider) {
    var path = $windowProvider.$get().STATIC_URL + 'dashboard/xneelo/containers/';
    $provide.constant('horizon.dashboard.xneelo.containers.basePath', path);

    var baseRoute = 'xneelo/containers/';
    $provide.constant('horizon.dashboard.xneelo.containers.baseRoute', baseRoute);
    ...
    $provide.constant('horizon.dashboard.xneelo.containers.containerRoute', containerRoute);
  ...
  run.$inject = [
    'horizon.dashboard.xneelo.containers.account.resourceType',
    'horizon.dashboard.xneelo.containers.container.resourceType',
