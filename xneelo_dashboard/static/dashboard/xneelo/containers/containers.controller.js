...
(function () {
   ...
   * @ngdoc controller
   *
   * @name horizon.dashboard.xneelo.containers.ContainersController
   *
   * @description
  ...
  angular
    ...
    .controller('horizon.dashboard.xneelo.containers.ContainersController', ContainersController);
  ...
  ContainersController.$inject = [
    ...
    'horizon.dashboard.xneelo.containers.baseRoute',
