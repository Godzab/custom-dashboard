...
(function() {
  ...
  describe('horizon.dashboard.xneelo.containers containers controller', function() {
    ...
    beforeEach(module('horizon.dashboard.xneelo.containers', function($provide) {
      $provide.value('horizon.dashboard.xneelo.containers.containers-model', fakeModel);
    }));
    ...
    function createController() {
      return controller(
        'horizon.dashboard.xneelo.containers.ContainersController', {
          $scope:scope,
          'horizon.dashboard.xneelo.containers.baseRoute': 'base ham',
          'horizon.dashboard.xneelo.containers.containerRoute': 'eggs '
        });
    }
