...
(function() {
  ...
  describe('horizon.dashboard.xneelo.containers.containerRoute constant', function () {
    var baseRoute, containerRoute, registry;

    beforeEach(module('horizon.dashboard.xneelo.containers'));
    beforeEach(inject(function ($injector) {
      baseRoute = $injector.get('horizon.dashboard.xneelo.containers.baseRoute');
      containerRoute = $injector.get('horizon.dashboard.xneelo.containers.containerRoute');
