...
(function() {
  ...
  describe('horizon.dashboard.xneelo.containers copy-object controller', function() {
    var controller, ctrl;
    ...
    beforeEach(inject(function ($injector) {
      ...
      ctrl = controller('horizon.dashboard.xneelo.containers.CopyObjectModalController');
    }));
