...
(function() {
  ...
  describe('horizon.dashboard.xneelo.containers objects controller', function() {
    beforeEach(module('horizon.framework'));
    beforeEach(module('horizon.app.core.openstack-service-api'));
    beforeEach(module('horizon.dashboard.xneelo.containers'));
    beforeEach(module(function before($provide) {
      $routeParams = {};
      $provide.value('$routeParams', $routeParams);
      $provide.constant('horizon.dashboard.xneelo.containers.basePath', '/base/path/');
      $provide.constant('horizon.dashboard.xneelo.containers.containerRoute', 'eggs/');
    }));
    ...
    function createController(folder) {
      ...
      return controller(
        'horizon.dashboard.xneelo.containers.ObjectsController',
        {$scope: $scope}
      );
    }
