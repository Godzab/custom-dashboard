...
(function() {
  ...
  describe('horizon.dashboard.xneelo.containers upload-object controller', function() {
    var controller, ctrl;
    ...
    beforeEach(module(function ($provide) {
      $provide.value('horizon.dashboard.xneelo.containers.containers-model', {
        container: {name: 'spam'},
        folder: 'ham'
      });
    }));
    ...
    beforeEach(inject(function ($injector) {
      ...
      ctrl = controller('horizon.dashboard.xneelo.containers.UploadObjectModalController');
