...
(function() {
  ...
  describe('horizon.dashboard.xneelo.workflow.launch-instance.workflow tests', function () {
    ...
    beforeEach(inject(function ($injector) {
      launchInstanceWorkflow = $injector.get(
        'horizon.dashboard.xneelo.workflow.launch-instance.workflow'
      );
      stepPolicy = $injector.get('horizon.dashboard.xneelo.workflow.launch-instance.step-policy');
    }));
