...
(function() {
  ...
  describe('Launch Instance Metadata Step', function() {
    ...
    describe('metadata tree', function() {
      ...
      beforeEach(module('horizon.dashboard.xneelo.workflow.launch-instance'));

      beforeEach(inject(function($injector) {
        var $compile = $injector.get('$compile');
        var $templateCache = $injector.get('$templateCache');
        var basePath = $injector.get('horizon.dashboard.xneelo.workflow.launch-instance.basePath');
