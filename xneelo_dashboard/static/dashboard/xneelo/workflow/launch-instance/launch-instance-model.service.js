...
(function () {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.xneelo.workflow.launch-instance
   *
   * @description
  ...
  launchInstanceModel.$inject = [
    ...
    'horizon.dashboard.xneelo.workflow.launch-instance.boot-source-types',
    'horizon.framework.widgets.toast.service',
    'horizon.app.core.openstack-service-api.policy',
    'horizon.dashboard.xneelo.workflow.launch-instance.step-policy'
  ];
